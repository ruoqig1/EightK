...
#SBATCH --output=/home/adidishe/EightK/out/GPUembedding_process_$i.out
#SBATCH --error=/home/adidishe/EightK/out/GPUembedding_process_$i.err
...
python3 embedding_processing_by_chunks.py $i 3
